...
| [pair-consult](./pair-consult) | 1.2.0 | Bounded Claude ↔ Codex consultation on one question — A proposes, B reviews, A responds, B re-reviews, A synthesizes and asks user. Round count and peer effort configurable. Lighter sibling to [pair-coding](./pair-coding) | — |
