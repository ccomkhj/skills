...
| [organize-skill-mcp](./organize-skill-mcp) | Scan all skill and MCP server configurations across Claude Code, Claude Desktop, Cursor, Windsurf, Codex, and Gemini CLI — global and per-project — and suggest cleanup | — |
